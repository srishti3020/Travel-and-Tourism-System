...
public class Destinations extends JFrame implements Runnable {
    ...
    JLabel[] label = new JLabel[] {l1, l2, l3, l4, l5, l6, l7, l8, l9, l0};
    JLabel caption;
    
    public void run() {
        String [] text = new String[] {"JW marriott hotel", "Madrin oriental Hotel", "Four Seasons Hotel", "Raddisson Hotel", "Classic Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Galaxy hotel", "Happy Morning Hotel"};
